...
declare class PrismaMariaDbAdapter extends MariaDbQueryable<mariadb.Pool> implements SqlDriverAdapter {
    ...
    constructor(client: mariadb.Pool, capabilities: Capabilities, mariadbOptions?: PrismaMariadbOptions | undefined, release?: (() => Promise<void>) | undefined);
...
export declare type PrismaMariadbOptions = {
