  ...
  async function searchHotels() {
    ...
    try {
      ...
      if (!response.ok || !data.success) {
        setError(
          data.message || "Demo hotel search नहीं हो सकी।"
        );
        return;
      }
      ...
      if (!data.hotels || data.hotels.length === 0) {
        setError(
          "इस destination के लिए कोई demo hotel option नहीं मिला।"
        );
      }
    } catch (error) {
      ...
      setError(
        "Hotel demo search service से connection नहीं हो पाया।"
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">
            Demo hotel search और booking flow review करें। Live hotel
            booking authorized provider integration के बाद उपलब्ध होगी।
          </p>
        </div>
        ...
        <div className="mb-8 bg-amber-50 border border-amber-200 rounded-xl p-5">
          ...
          <p className="text-sm text-amber-800 mt-1">
            Hotel names, availability, ratings, reviews, room details और
            fares अभी demo data हैं। ये live hotel inventory, final fare
            या confirmed room availability नहीं हैं।
          </p>
        </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-5">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  ...
                  {rooms} {Number(rooms) === 1 ? "Room" : "Rooms"}
                </p>
              </div>

              <span className="text-sm text-gray-500">
                {hotels.length} demo options
              </span>
            </div>
            ...
            {hotels.length === 0 && (
              <div className="bg-white rounded-xl shadow p-10 text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mt-4">
                  No Demo Hotels Found
                </h3>

                <p className="text-gray-500 mt-2">
                  इस destination के लिए अभी कोई demo hotel option उपलब्ध
                  नहीं है।
                </p>
              </div>
            )}
                  ...
                  >
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                      ...
                      <div className="flex-1">
                        <span className="inline-block mb-2 bg-amber-100 text-amber-800 px-3 py-1 rounded-full text-xs font-bold">
                          DEMO
                        </span>
