...
export default function AepsDepositPage() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!Number.isFinite(cleanAmount) || cleanAmount <= 0) {
      setError("कृपया सही Deposit Amount डालें।");
      return;
    }

    if (!consent) {
      setError("AEPS Cash Deposit के लिए consent देना जरूरी है।");
      return;
    }

    /*
      IMPORTANT:
      अभी यहाँ कोई real AEPS / banking API call नहीं होगी।

      Actual Cash Deposit authorized AEPS provider
      integration के बाद enable होगा।

      Aadhaar Number को URL/query string में कभी नहीं भेजना है।
    */

    setMessage(
      "Form validation successful है। Actual Cash Deposit authorized AEPS provider integration के बाद उपलब्ध होगा।"
    );
  }
        ...
        <div className="rounded-2xl bg-white p-8 shadow">
          ...
          <div className="mt-6 rounded-lg border border-yellow-200 bg-yellow-50 p-4">
            ...
            <p className="mt-1 text-sm text-yellow-700">
              अभी यह page setup mode में है। Actual Cash Deposit authorized
          ...
          <form onSubmit={handleSubmit} className="mt-8">
            ...
            <label className="mt-6 flex cursor-pointer items-start gap-3 rounded-lg bg-gray-50 p-4">
              ...
              <span className="text-sm text-gray-600">
                मैं AEPS Cash Deposit request के लिए अपनी सहमति देता/देती हूँ
                और समझता/समझती हूँ कि actual transaction के लिए biometric
                authentication और authorized provider आवश्यक हो सकता है।
              </span>
            </label>
