...
async function readJsonResponse(response: Response) {
  ...
  if (!contentType.includes("application/json")) {
    ...
    return {
      ...
      message:
        response.status === 404
          ? "Requested API endpoint नहीं मिला। कृपया backend process route check करें।"
          : `Server ने JSON की जगह invalid response दिया। HTTP ${response.status}`,
    };
  }
...
function MobilePostpaidPaymentContent() {
      ...
      const options = {
        ...
        handler: async function (
          ...
          try {
            ...
            setMessage(
              "Payment verified successfully. अब postpaid bill process किया जा रहा है..."
            );
            ...
            console.log(
              "STARTING POSTPAID PROCESS:",
              transactionId
            );

            const processResponse =
              await fetch(
                "/api/recharge/postpaid/process",
                {
                  method: "POST",
            ...
            if (
              ...
              setError(
                processData.message ||
                  "Payment successful है, लेकिन postpaid bill processing नहीं हुआ।"
              );

              setMessage(
                "Payment सफल हो चुका है। Postpaid bill processing में समस्या आई है।"
              );
            ...
            setMessage(
              `Mobile Postpaid payment successful! Transaction ID: ${transactionId}`
            );

            console.log(
              "POSTPAID PAYMENT COMPLETED:",
              transactionId
            );
            ...
            console.error(
              "POSTPAID PAYMENT ERROR:",
              err
            );

            setError(
              "Payment verification या postpaid processing में समस्या हुई।"
            );
      ...
      <div className="max-w-xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-xl shadow p-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 text-center">
            Mobile Postpaid Payment
          </h2>

          <p className="text-gray-500 text-center mt-2">
            अपना postpaid bill payment complete करें
          </p>
...
export default function MobilePostpaidPaymentPage() {
  return (
    <Suspense
      fallback={
