...
// ======================================================
// ELECTRICITY PAYMENT CONTENT
// ======================================================

function ElectricityPaymentContent() {
      ...
      const options = {
        ...
        handler: async function (
          ...
          try {
            ...
            setMessage(
              "Payment verified successfully. अब Electricity bill payment process किया जा रहा है..."
            );

            console.log(
              "ELECTRICITY PAYMENT VERIFIED:",
              transactionId
            );
            ...
            console.log(
              "STARTING ELECTRICITY PROCESS:",
              transactionId
            );

            const processResponse =
              await fetch(
                "/api/recharge/electricity/process",
                {
                  method: "POST",
            ...
            if (
              ...
              setError(
                processData.message ||
                  "Payment successful है, लेकिन Electricity bill processing नहीं हुआ।"
              );

              setMessage(
                "Payment सफल हो चुका है, लेकिन Electricity bill payment processing में समस्या आई है।"
              );
            ...
            setMessage(
              `Electricity bill payment successful! Transaction ID: ${transactionId}`
            );
            ...
            setError(
              "Payment verification या Electricity processing में समस्या हुई।"
            );
      ...
      <div className="max-w-xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-xl shadow p-8">
          ...
          <p className="text-gray-500 text-center mt-2">
            अपना Electricity bill payment complete करें
          </p>
